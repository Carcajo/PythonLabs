...
class TestCart(APITestCase):
    def test_cart_add_no_login_post(self):
        ...
        prod = Product.objects.create(name="pasta", slug="karbonara", descrition="ahfjskdl", price=123.0, category=food)
    ...
    def test_add_to_cart_login_post(self):
        ...
        food = Category.objects.create(name="food", slug="dinner")
        prod = Product.objects.create(name="pasta", slug="karbonara", description="ahfjskdl", price=123.0, category=food)
